...
SECRET_KEY = 'django-insecure-sz31x#qd+e32jc7w4qfm2u!)l0lfvlka=zcm8fu(r5up75&i_%'
...
ROOT_URLCONF = 'DR_ARIF_DENTAL_SOFTWARE.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'WEBSITE/website_templates'),
...
WSGI_APPLICATION = 'DR_ARIF_DENTAL_SOFTWARE.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'anjali.techfifo@gmail.com'
